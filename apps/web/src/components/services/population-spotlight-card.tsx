...
import type { PopulationTheme } from "@kalamos/compendium-data";
...
export function PopulationSpotlightCard({ theme }: { theme: PopulationTheme }) {
  return (
    <Card className="flex flex-col h-full">
      <CardHeader>
        ...
        <Badge variant="primary" className="w-fit">
          {theme.interventionCount} interventions
        </Badge>
      </CardHeader>
      <CardContent className="flex flex-col flex-1 gap-4">
        <p className="text-sm text-warm-600">{theme.description}</p>
